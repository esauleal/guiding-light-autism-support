      ...
      >
        <div className="h-full bg-white rounded-2xl shadow-lg p-8 text-center hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
          ...
          <p className="text-gray-600 leading-7">
            Sometimes you simply need someone who understands. As parents
            raising two adult children with autism, we provide a safe,
            compassionate space to ask questions, share concerns, receive
            encouragement, and talk with someone who has walked a similar
            journey.
          </p>
...
>
  <div className="h-full bg-blue-700 text-white rounded-2xl shadow-xl p-8 text-center hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
    ...
    <p className="text-sm text-blue-100 mt-5">
      Additional research beyond the included 2 hours is available at
      $175/hour.
    </p>
    ...
    <div className="mt-16 bg-blue-50 rounded-2xl p-8 text-center hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
      ...
      <p className="text-gray-600 leading-8">
        ...
        experiences, practical guidance, and emotional support from parents
        who have lived the autism journey themselves. These sessions are
        not counseling, therapy, or medical advice, but an opportunity to
