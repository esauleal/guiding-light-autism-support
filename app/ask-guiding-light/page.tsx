  ...
  <div className="flex items-start gap-4">
    ...
    <div>
      ...
      <p className="mt-3 text-gray-700 leading-8">
        Whether your child was diagnosed today or you've been navigating
        autism for years, we're here to help.
      </p>
...
>
            ...
            {loading ? "Guiding Light is thinking..." : "Ask Guiding Light"}
          </button>
          {answer && (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {exampleQuestions.map((item, index) => {
              ...
              return (
                <button
                  key={index}
                  className="flex items-center gap-4 rounded-2xl bg-white p-6 shadow-md hover:shadow-xl hover:-translate-y-1 transition"
                >
